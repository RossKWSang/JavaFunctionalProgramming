...
import mvc.mvc.controller.RequestMethod;
...
public class AnnotationHandlerMapping implements HandlerMapping{
    ...
    public void initialize() {
        ...
        Set<Class<?>> clazzesWithControllerAnnotation = reflections.getTypesAnnotatedWith(mvc.mvc.annotation.Controller.class, true);
